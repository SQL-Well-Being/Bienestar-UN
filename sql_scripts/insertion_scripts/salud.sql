USE bienestar_UN;
-- PARA CORRER ESTE ARCHIVO ES NECESARIO PRIMERO CORRER LAS INSERCIONES DEL SISTEMA DE INFORMACIÓN.
-- Inserciones en la tabla bienestar_UN.DISCAPACIDAD
INSERT INTO bienestar_UN.DISCAPACIDAD (dis_id, dis_nombre) VALUES 
...
-- Inserción: Perfil de salud
INSERT INTO bienestar_UN.PERFIL_DE_SALUD_TIENE_DISCAPACIDAD (dis_id, perfsalud_id) VALUES
(1, 5),
(2, 10),
(3, 15),
(4, 20),
...
-- Incapacidades
INSERT INTO bienestar_UN.INCAPACIDAD (inc_id, inc_fecha_inicio, inc_fecha_fin, inc_est_per_DNI) VALUES
(1, '2023-01-10 00:00:00', '2023-01-20 00:00:00', 111111100),
(2, '2023-02-05 00:00:00', '2023-02-15 00:00:00', 111111101),
(3, '2023-03-12 00:00:00', '2023-03-22 00:00:00', 111111102),
(4, '2023-04-18 00:00:00', '2023-04-28 00:00:00', 111111103),
(5, '2023-05-25 00:00:00', '2023-06-04 00:00:00', 111111100),
(6, '2023-06-30 00:00:00', '2023-07-10 00:00:00', 111111103),
(7, '2023-07-15 00:00:00', '2023-07-25 00:00:00', 111111100),
(8, '2023-08-20 00:00:00', '2023-08-30 00:00:00', 111111122),
(9, '2023-09-10 00:00:00', '2023-09-20 00:00:00', 111111130),
(10, '2023-10-05 00:00:00', '2023-10-15 00:00:00', 111111140),
(11, '2023-11-12 00:00:00', '2023-11-22 00:00:00', 111111100);


-- Creación de eventos generales para eventos específicos de salud.
-- Inserciones para eventos de salud con IDs y reservaciones a partir de 200
...
INSERT INTO bienestar_UN.SESION_EVENTO_SALUD (ses_salud_eve_id, ses_salud_nombre) VALUES
...
-- Reservaciones de espacios para citas individuales
INSERT INTO bienestar_UN.RESERVACION (res_id, res_fecha_inicial, res_fecha_fin, res_esp_id)
VALUES
-- Reservaciones para consultorio A
...
-- Reservaciones para consultorio B
...
-- Reservaciones para consultorio C
...
-- Reservaciones para consultorio D
...
-- Creación de eventos asociados a las reservaciones con el nombre del estudiante
INSERT INTO bienestar_UN.EVENTO_GENERAL (eve_id, eve_descripcion, eve_res_id)
VALUES
-- Eventos para consultorio A
...
-- Creación de citas individuales asociadas a los eventos generales
INSERT INTO bienestar_UN.CITA_INDIVIDUAL (cit_tipo, cit_est_per_DNI, cit_fun_per_DNI, cit_eve_id)
VALUES
...
-- Asignación de estudiantes a sesiones de eventos de salud (90 inserciones)
INSERT INTO bienestar_UN.ESTUDIANTE_ASISTE_A_SESION_EVENTO_SALUD (ses_salud_ses_id, est_per_DNI) VALUES
(200, 111111100),
(200, 111111101),
(200, 111111102),
(201, 111111103),
